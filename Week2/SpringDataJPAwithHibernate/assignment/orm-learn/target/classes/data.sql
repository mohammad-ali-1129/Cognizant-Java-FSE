...
-- Employee Seed Data
insert into employee (em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values ('John Doe', 50000.00, true, '1995-12-01', 1);
insert into employee (em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values ('Jane Smith', 60000.00, true, '1996-10-15', 1);
insert into employee (em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) values ('Alice Johnson', 45000.00, false, '1998-05-20', 2);
...
-- Employee Skill Mapping Seed Data
